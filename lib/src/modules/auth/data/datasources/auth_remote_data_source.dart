...
class AuthRemoteDataSourceImpl implements AuthRemoteDataSource {
  ...
  Future<String> register(String email, String password, String phone) async {
    final response = await _api.post('/master_auth/auth/register', data: {
      'email': email,
      'password': password,
      'phone': phone,
      'user_type': 'customer'
  ...
  Future<String> login(String email, String password) async {
    ...
    final response = await _api.post('/master_auth/auth/login', data: {
      'identity': email,
      'password': password,
      'device_id': deviceId
    });
  ...
  Future<String> resetPassword(String email, String resetToken, String newPassword) async {
    final response = await _api.post('/master_auth/auth/reset_password', data: {
      'email': email,
  ...
  Future<Map<String, dynamic>> verifyOtp(String email, String otp) async {
    ...
    final response = await _api.post('/master_auth/auth/verify_otp', data: {
      'email': email,
      'otp': otp,
      'device_id': deviceId
    });
