...
class Ulid {
  ...
  static void _decode(Uint8List buffer, int inS, int inE, Uint8List data, int outS, int outE) {
    var value = BigInt.from(0);
    for (var i = inS; i <= inE; i++) {
...
List<String> _base32 = List<String>.generate(32, (int i) => _crockfordBase32[i]);

List<int> _lowercaseCodes = List<int>.generate(32, (int i) => _crockfordBase32[i].codeUnits.first);
List<int> _base32Decode = List<int>.generate(256, (int i) => _lowercaseCodes.indexOf(i));
